            ...
            <div class="col-md-6 col-lg-4">
                <div class="card login-card">
                    <div class="login-header">
                        <i class="ri-admin-line display-4 mb-3"></i>
                        <h3 class="mb-0">Admin Login</h3>
                        <p class="mb-0 opacity-75">Welcome back to CMS Panel</p>
                    </div>
                    <div class="card-body p-4">
                        @if ($errors->any())
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                @foreach ($errors->all() as $error)
                                    <i class="ri-error-warning-line me-2"></i>{{ $error }}<br>
                                @endforeach
                        ...
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-login">
                                    <i class="ri-login-box-line me-2"></i>Login to Admin Panel
                                </button>
                            </div>
                        </form>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('home') }}" class="text-decoration-none text-muted">
                                <i class="ri-arrow-left-line me-2"></i>Back to Website
                            </a>
                        </div>
                    </div>
                </div>
