                    ...
                    <form action="{{ route('admin.tags.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') }}" required placeholder="Enter tag name">
                            @error('name')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2"><i class="ri-lightbulb-line text-warning me-2"></i>Keep names short and
                            descriptive</li>
                        <li class="mb-2"><i class="ri-lightbulb-line text-warning me-2"></i>Use consistent naming
                            convention</li>
                        <li class="mb-2"><i class="ri-lightbulb-line text-warning me-2"></i>Avoid duplicate or similar
                            tags</li>
                        <li class="mb-2"><i class="ri-lightbulb-line text-warning me-2"></i>Consider using existing tags
                            first</li>
